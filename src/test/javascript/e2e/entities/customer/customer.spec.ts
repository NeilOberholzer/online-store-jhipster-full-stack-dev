  ...
  it('should create and save Customers', async () => {
    ...
    await promise.all([
      ...
      customerUpdatePage.setEmailInput(
        'Tta&lt;SQ$V&#39;/y~(]v&lt;AM@&#39;Cr[vQR3+`D`NQ.cQ*asEHX`:}/lr3w!n]nmRZ4O?%2X`R%av*_c`u?/wgdpx7qL}ltV.uL$Uixk/d=0N8H'
      ),
    ...
    expect(await customerUpdatePage.getEmailInput()).to.eq(
      'Tta&lt;SQ$V&#39;/y~(]v&lt;AM@&#39;Cr[vQR3+`D`NQ.cQ*asEHX`:}/lr3w!n]nmRZ4O?%2X`R%av*_c`u?/wgdpx7qL}ltV.uL$Uixk/d=0N8H',
      'Expected Email value to be equals to Tta&lt;SQ$V&#39;/y~(]v&lt;AM@&#39;Cr[vQR3+`D`NQ.cQ*asEHX`:}/lr3w!n]nmRZ4O?%2X`R%av*_c`u?/wgdpx7qL}ltV.uL$Uixk/d=0N8H'
    );
